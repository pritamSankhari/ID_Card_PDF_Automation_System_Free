...
let init = function(){
	for(let i=0;i<gridsForView.length;i++){
		...
		fields[i].imageWidth = gridImageWidth[i].value + "%"
		// ----------------------------------------------

		// ----------------------------------------------
		// INITIALIZE FIELD IMAGE HEIGHT
		fields[i].imageHeight = gridImageHeight[i].value + "%"
		// ----------------------------------------------
		...
		gridImage[i].addEventListener('change',function(){
			if(gridImage[i].value!='none'){
				...
				fields[i].imageWidth = gridsForView[i].children[0].style.width = gridImageWidth[i].value+"%"
				fields[i].imageHeight = gridsForView[i].children[0].style.height = gridImageHeight[i].value+"%"
